...
- 1x ESP8266 Module
-- You will also need a flash tool and flash module to proram the ESP8266 -- lots of documentaion online.
-- CAUTION: the ESP8266 module is 3.6v, so the voltage must be managed from the 5v off of the Ardino Nano board.
